...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.lataaKysymykset(), $async$main);
            case 2:
              // returning from await.
              kysymykset = $async$result;
    ...
    lataaKysymykset() {
      ...
      var $async$lataaKysymykset = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.HttpRequest_getString("kysymykset.json"), $async$lataaKysymykset);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.$index$asx($async$temp2.decode$2$reviver(0, $async$result, null), "kysymykset");
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$lataaKysymykset, $async$completer);
    },
